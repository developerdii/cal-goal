        ...
        >
          <div class="shrink-0 px-5 pt-5 pb-3">
            <template v-if="eyebrow">
              <div class="mb-1.5 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                <p
                  class="min-w-0 text-[13px] font-semibold uppercase tracking-[0.08em] text-slate-400 dark:text-slate-500"
                >
                  {{ eyebrow }}
                </p>
